    ...
    <div class="flex flex-col lg:flex-row min-h-screen w-full overflow-hidden">
        ...
        <div class="hilo-blue w-full lg:w-1/2 h-64 sm:h-80 lg:h-auto relative flex items-center justify-center pb-6">
            ...
            <div class="absolute top-0 right-0 transform rotate-[-30deg]">
                <img src="{{ asset('images/excecise 1.png') }}" alt="Exercise Figure 1"
            ...
            <div class="absolute bottom-0 left-0 transform translate-x-0 translate-y-0">
                <img src="{{ asset('images/excercise 2.png') }}" alt="Exercise Figure 2"
                ...
                <div class="mb-12 w-full absolute lg:top-20 top-10">
                    <ol class="relative flex items-center w-full text-secondaryColor">
                        ...
                        <li class="flex-1 text-center relative">
                            ...
                            <div class="absolute top-3 left-1/2 w-full h-[6px] bg-secondaryColor -z-10"></div>
                        </li>
                        ...
                        <li class="flex-1 text-center relative">
                            ...
                            <div class="absolute top-3 left-1/2 w-full h-[6px] bg-white -z-10"></div>
                        </li>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center relative px-4 md:px-8 py-10 lg:py-0"
            ...
            <div class="relative z-10 w-full max-w-sm">
                ...
                <div
                    ...
                    <h2 class="text-center text-blue-900 font-bold text-xl sm:text-2xl mb-6">
                        Personal Data
                    </h2>
                    <form method="POST" action="{{ route('personaldatapost') }}">
                        ...
                        <div class="mb-4">
                            <!-- Full Name -->
                            <div class="mb-4">
                                <label for="fullname" class="block text-blue-900 text-sm font-bold mb-1">
                                    Nama Lengkap
                                </label>
                                <input type="text" id="fullname" placeholder="John Doe" name="name"
                            ...
                            <!-- umur -->
                            <div class="mb-4">
                                <label for="umur" class="block text-blue-900 text-sm font-bold mb-1">
                                    Umur
                                </label>
                                <input type="number" id="umur" placeholder="21" name="umur"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold text-sm" />
                            </div>
                            ...
                            <div class="mb-4 w-full">
                                <label for="gender" class="block text-blue-900 text-sm font-bold mb-1">
                                    Jenis Kelamin
                                </label>
                                ...
                                <!-- Shirt Size -->
                                <div class="mb-4 w-full">
                                    <label for="shirt-size" class="block text-blue-900 text-sm font-bold mb-1">
                            ...
                            <div class="mb-4">
                                <label for="asal" class="block text-blue-900 text-sm font-bold mb-1">
                                    Asal
                                </label>
                                <input type="text" id="asal" name="asal" placeholder="Palembang"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold text-sm" />
                            </div>

                            <div class="mb-4">
                                <label for="komunitas" class="block text-blue-900 text-sm font-bold mb-1">
                                    Nama Komunitas (Opsional)
                                </label>
                                <input type="text" id="komunitas" name="nama_komunitas" placeholder="Komunitas"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold text-sm" />
                            </div>
                        </div>

                        <!-- Buttons Container -->
                        <div class="mt-5 sm:mt-6 z-50 flex flex-col sm:flex-row gap-3 sm:gap-4">
                            <button type="submit"
            ...
            <!-- Bottom Figures -->
            <div class="absolute bottom-0 left-0 transform -translate-x-1/4 translate-y-12 sm:translate-y-8 z-0">
