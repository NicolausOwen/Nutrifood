...
<body class="bg-gray-100 p-6">
    ...
    <a href="{{ route('tickets.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Create
        Ticket</a>
        ...
        <tbody>
            @forelse ($tickets as $ticket)
                <tr>
                    ...
                    <td class="py-2 px-4 border-b">{{ $ticket->masuk ? 'Yes' : 'No' }}</td>
                    <td class="py-2 px-4 border-b">
                        <a href="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data={{ $ticket->qr_code }}"
                            target="_blank">
                            View QR
                        </a>
                    </td>
