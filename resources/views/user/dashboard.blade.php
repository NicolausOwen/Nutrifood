        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 px-8 py-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Hai StrongFest</h1>
            ...
            <main class="flex-1 p-8">
                <div class="max-w-7xl mx-auto">
                    <!-- Title Section -->
                    <div class="mb-8">
                        <h2 class="text-4xl font-bold text-hilo-green mb-2">Order Kamu</h2>
                        <p class="text-gray-600">Total Order: {{ $orders->count() }}</p>
                    </div>
                    ...
                    @else
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                            ...
                            <p class="text-gray-600 mb-6">Anda belum memiliki order tiket untuk Hilo Strong Fest</p>
